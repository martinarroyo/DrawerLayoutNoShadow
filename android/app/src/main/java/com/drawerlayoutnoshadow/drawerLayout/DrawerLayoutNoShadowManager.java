...
/**
 * View Manager for {@link DrawerLayoutNoShadow} components.
 */
@ReactModule(name = DrawerLayoutNoShadowManager.REACT_CLASS)
public class DrawerLayoutNoShadowManager extends ViewGroupManager<DrawerLayoutNoShadow> {

  protected static final String REACT_CLASS = "DrawerLayoutNoShadow";
  ...
  @Override
  protected void addEventEmitters(ThemedReactContext reactContext, DrawerLayoutNoShadow view) {
  ...
  @Override
  protected DrawerLayoutNoShadow createViewInstance(ThemedReactContext context) {
    return new DrawerLayoutNoShadow(context);
  }

  @ReactProp(name = "drawerPosition", defaultInt = Gravity.START)
  public void setDrawerPosition(DrawerLayoutNoShadow view, int drawerPosition) {
  ...
  public void getDrawerWidth(DrawerLayoutNoShadow view, float width) {
    int widthInPx = Float.isNaN(width) ?
        DrawerLayoutNoShadow.DEFAULT_DRAWER_WIDTH : Math.round(PixelUtil.toPixelFromDIP(width));
    view.setDrawerWidth(widthInPx);
  }

  @ReactProp(name = "drawerLockMode")
  public void setDrawerLockMode(DrawerLayoutNoShadow view, @Nullable String drawerLockMode) {
  ...
  @Override
  public void setElevation(DrawerLayoutNoShadow view, float elevation) {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      try {
        Method method = DrawerLayoutNoShadow.class.getMethod("setDrawerElevation", float.class);
   ...
   */
  @Override
  public void addView(DrawerLayoutNoShadow parent, View child, int index) {
